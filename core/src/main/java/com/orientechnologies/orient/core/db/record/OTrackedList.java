...
public class OTrackedList<T> extends ArrayList<T> implements ORecordElement, OTrackedMultiValue<Integer, T>, Serializable {
  ...
  public OTrackedList(final ORecordAbstract iRecord, final Collection<? extends T> iOrigin, final Class<?> iGenericClass) {
    this(iRecord);
  ...
  public OTrackedList(final ORecordAbstract iSourceRecord) {
